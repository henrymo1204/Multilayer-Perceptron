...
class NeuralNetwork:
    def __init__(self):  # constructor
        ...
        self.hiddenNodes = 2
        self.outputNodes = 1
        self.weights_input_to_hidden = [[random.choice([-0.5, 0.5]) for x in range(self.inputNodes)] for y in
                                        range(self.hiddenNodes)]
        self.weights_hidden_to_output = [[random.choice([-0.5, 0.5]) for x in range(self.hiddenNodes)] for y in
